    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Tipos de Cuidado</h3>
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to="/encontrar-cuidador" className="hover:text-gray-100 transition-colors">
                  Cuidado de Idosos
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link to="/como-funciona" className="hover:text-gray-100 transition-colors">
                  Como Funciona
                </Link>
              </li>
              <li>
                <Link to="/seja-um-cuidador" className="hover:text-gray-100 transition-colors">
                  Seja um Cuidador
                </Link>
              </li>
              <li>
